...
<div class="timeline">
    ...
    <div class="timeline__card">
      <div class="timeline__header" onclick="this.parentElement.classList.toggle('expanded')">
        <div class="timeline__title-row">
          <h3 class="timeline__role">Senior Solutions Architect</h3>
          <span class="timeline__toggle"><i class="fas fa-chevron-down"></i></span>
        </div>
        <p class="timeline__company">Amazon Web Services (AWS)</p>
  ...
  <div class="timeline__item" data-year="2020–2022">
    <div class="timeline__card">
      <div class="timeline__header" onclick="this.parentElement.classList.toggle('expanded')">
        <div class="timeline__title-row">
          <h3 class="timeline__role">Solutions Architect</h3>
          <span class="timeline__toggle"><i class="fas fa-chevron-down"></i></span>
        </div>
        <p class="timeline__company">Amazon Web Services (AWS)</p>
  ...
  <div class="timeline__item" data-year="2017">
    <div class="timeline__card">
      <div class="timeline__header" onclick="this.parentElement.classList.toggle('expanded')">
        <div class="timeline__title-row">
          <h3 class="timeline__role">Development Team Leader</h3>
          <span class="timeline__toggle"><i class="fas fa-chevron-down"></i></span>
        </div>
        <p class="timeline__company">RadarServices GmbH</p>
  ...
  <div class="timeline__item" data-year="2016">
    <div class="timeline__card">
      <div class="timeline__header" onclick="this.parentElement.classList.toggle('expanded')">
        <div class="timeline__title-row">
          <h3 class="timeline__role">Software Developer</h3>
          <span class="timeline__toggle"><i class="fas fa-chevron-down"></i></span>
        </div>
        <p class="timeline__company">RadarServices GmbH</p>
  ...
  <div class="timeline__item" data-year="2015–2016">
    <div class="timeline__card">
      <div class="timeline__header" onclick="this.parentElement.classList.toggle('expanded')">
        <div class="timeline__title-row">
          <h3 class="timeline__role">Postdoctoral Researcher</h3>
          <span class="timeline__toggle"><i class="fas fa-chevron-down"></i></span>
        </div>
        <p class="timeline__company">Trinity College Dublin</p>
  ...
  <div class="timeline__item" data-year="2012–2015">
    <div class="timeline__card">
      <div class="timeline__header" onclick="this.parentElement.classList.toggle('expanded')">
        <div class="timeline__title-row">
          <h3 class="timeline__role">Teaching Assistant</h3>
          <span class="timeline__toggle"><i class="fas fa-chevron-down"></i></span>
        </div>
        <p class="timeline__company">Trinity College Dublin</p>
