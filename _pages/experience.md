  ...
  <div class="timeline__item" data-year="2022–Present">
    <div class="timeline__card">
      ...
      <div class="timeline__body">
        ...
        <p>My main project in the agentic AI space re-imagines the developer portal experience: instead of clicking through a portal, developers describe their application and an agent bootstraps the infrastructure across AWS accounts according to codified best practices. Built on <a href="https://github.com/strands-agents/sdk-python">Strands Agents</a> SOPs — machine-readable runbooks with RFC 2119 keywords, parameterized inputs, and progress tracking — the reference implementation takes a web application from description to production across three AWS accounts (~150 resources, 6 Terraform modules) in under an hour, with a human reviewing the plan and gating production. The same task used to be a two-week runbook exercise. I've presented this work several times, and it's where my current thinking on agentic systems comes from.</p>
