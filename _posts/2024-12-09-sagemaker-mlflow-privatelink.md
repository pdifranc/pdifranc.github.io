...
toc: true
header:
 teaser: "posts/sagemaker-mlflow-privatelink/architecture.png"
 og_image: "posts/sagemaker-mlflow-privatelink/architecture.png"
tags:
  - sagemaker
  - mlflow
  - privatelink
...
![Architecture: a SageMaker Studio domain in a private subnet of the customer VPC with no internet route; VPC endpoints for sagemaker.experiments, S3, sagemaker.api, codeartifact.api, EC2, ECR, CloudWatch Logs, and STS connect it over AWS PrivateLink to the managed MLflow tracking server in the SageMaker service account, the MLflow artifact bucket, and a private CodeArtifact PyPI repository](/images/posts/sagemaker-mlflow-privatelink/architecture.png)
